...
class Adaptador(arrayListActividades2: ArrayList<Actividades>) : RecyclerView.Adapter<Adaptador.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDuracion.text = actividad.tiempoTranscurrido
